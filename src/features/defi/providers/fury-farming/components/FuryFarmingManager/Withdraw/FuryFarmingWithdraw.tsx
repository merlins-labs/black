...
type FuryFarmingWithdrawProps = {
  accountId: AccountId | undefined
  onAccountIdChange: AccountDropdownProps['onChange']
}
export const FuryFarmingWithdraw: React.FC<FuryFarmingWithdrawProps> = ({
  accountId,
  ...
  const StepConfig: DefiStepProps = useMemo(() => {
    return {
      [DefiStep.Info]: furyFarmingOpportunity?.expired
        ? {
        ...
        : {
            ...
            description: translate('defi.steps.withdraw.info.description', {
              asset: furyFarmingOpportunity?.name,
            }),
            component: ownProps => (
              <Withdraw
                {...ownProps}
    ...
    accountId,
    furyFarmingOpportunity?.expired,
    furyFarmingOpportunity?.name,
    handleAccountIdChange,
    translate,
  ])

  if (loading || !furyFarmingOpportunity)
    return (
