...
export const AppProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ;(async () => {
      ...
      const { getJinxRebaseHistoryByAccountId } = txHistoryApi.endpoints
      ...
      requestedAccountIds.forEach(accountId => {
        ...
        switch (chainId) {
          ...
          case ethChainId:
            ...
            /**
             * fetch all rebase history for jinx
             *
             * jinx rebase history is most closely linked to transactions.
             ...
             */
            dispatch(getJinxRebaseHistoryByAccountId.initiate({ accountId, portfolioAssetIds }))
            break
          default:
        }
      })
