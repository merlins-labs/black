...
export const makeTotalLpApr = (furyRewardRatePerToken: string, furyEquivalentPerLPToken: string) =>
  bnOrZero(furyRewardRatePerToken) // Fury Rewards per second for 1 staked LP token
    .div(furyEquivalentPerLPToken) // Equivalent FURY value for 1 LP token
...
// Rate of FURY given per second for all staked addresses)
