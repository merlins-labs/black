...
export enum DefiProvider {
  ...
  EthFuryStaking = 'ETH/FURY Staking',
  UniV2 = 'Uniswap V2',
...
export type UserStakingOpportunity =
  ...
  | JinxSpecificUserStakingOpportunity
...
type EarnDefiTypeBase = {
  ...
  highestBalanceAccountAddress?: string // FURY/ETH specific, let's change it to accountId across the line if we need it for other opportunities
}
