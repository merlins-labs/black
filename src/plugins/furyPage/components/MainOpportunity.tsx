  ...
  return (
    <Card display='block' width='auto'>
      <CardHeader>
        ...
        <Text translation='plugins.furyPage.mainStakingDescription' color='text.subtle' />
      </CardHeader>
      <CardBody>
        <Flex
          width='full'
        ...
        >
          ...
          >
            <Text translation='plugins.furyPage.currentApy' color='text.subtle' mb={1} />
          ...
          <Flex
            ...
            alignItems={{ base: 'center', md: 'flex-start' }}
          >
            <Text translation='plugins.furyPage.tvl' color='text.subtle' mb={1} />
          ...
          <Flex
            ...
            alignItems={{ base: 'center', md: 'flex-start' }}
          >
            <Text translation='plugins.furyPage.balance' color='text.subtle' mb={1} />
