...
export class Parser implements SubParser<Tx> {
  ...
  readonly supported0x0eafe556aebc3fdd512006b78ed36990451fa3b8Functions = {
  ...
  async parse(tx: Tx): Promise<TxSpecific | undefined> {
    ...
    const supportedSigHashes = [
      ...Object.values(this.supported0x0eafe556aebc3fdd512006b78ed36990451fa3b8Functions),
    ...
    switch (txSigHash) {
      ...
      case this.supported0x0eafe556aebc3fdd512006b78ed36990451fa3b8Functions.depositSigHash:
  ...
  getAbiInterface(txSigHash: string | undefined): ethers.utils.Interface | undefined {
    ...
    if (
      Object.values(this.supported0x0eafe556aebc3fdd512006b78ed36990451fa3b8Functions).some(
        abi => abi === txSigHash,
      )
    )
