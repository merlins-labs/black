...
import yearnDepositBlackFuryRouter from './mockData/yearnDepositBlackFuryRouter'
...
describe('parseTx', () => {
        ...
        transfers: [
          {
            ...
            assetId: 'eip155:1/erc20:0x3c3dc25ca709de108f6fc9b04bef5976876b05b1',
  ...
  describe('yearn', () => {
    ...
    it('should parse Yearn deposit to 0x0eafe556aebc3fdd512006b78ed36990451fa3b8 router', async () => {
      const { tx } = yearnDepositBlackFuryRouter
      const address = '0x1399D13F3A0aaf08f7C5028D81447a311e4760c4'
      ...
      const expected: ParsedTx = {
        ...
        transfers: [
          ...
          },
          {
            ...
            assetId: 'eip155:1/erc20:0x0eafe556aebc3fdd512006b78ed36990451fa3b8',
            totalValue: '109548875260073394762',
            components: [{ value: '109548875260073394762' }],
            token: jinxToken,
          },
